(() => {
    ...
    function initSliders() {
        if (document.querySelector(".slider-activity")) new swiper_core_Swiper(".slider-activity", {
            slidesPerView: 1.2,
            spaceBetween: 32,
            speed: 800,
            breakpoints: {
        ...
        if (document.querySelector(".images-activity-slider")) new swiper_core_Swiper(".images-activity-slider", {
