(() => {
    ...
    function initSliders() {
        ...
        if (document.querySelector(".services-slider")) new swiper_core_Swiper(".services-slider", {
            modules: [ Navigation ],
            slidesPerView: 1,
            spaceBetween: 24,
            speed: 800,
        ...
        if (document.querySelector(".gallery-slider")) new swiper_core_Swiper(".gallery-slider", {
            modules: [ Navigation ],
            slidesPerView: 2.6,
            spaceBetween: 24,
            speed: 800,
